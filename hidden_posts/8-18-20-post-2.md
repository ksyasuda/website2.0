...
This is another post but it's not the **_Last_** post probably

---
this is just some code that i use in the travel app
  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* {this.state.success} */}
        <Button disabled={false} clicked={this.getLocation}>
          Find Location
        </Button>
        <Button disabled={false} clicked={this.onSendHandler}>
          Send It!
        </Button>
        <Button disabled={false} clicked={this.onZoomHandler}>
          Zoom In
        </Button>
